    ...
    <div class="kanan">
        <div class="container-fluid">
            ...
            <div class="form-container">
                <form action="function.php?act=ubahSolusi&id_solusi=<?= $data['id_solusi']; ?>" method="POST">
                    <div class="form-group">
                        <h3>Form Ubah Solusi</h3>
                    </div>
                    <div class="form-group">
                        <label for="namaSolusi">Solusi</label>
                        <input type="text" class="form-control" id="namaSolusi" name="namaSolusi" 
                               value="<?= htmlspecialchars($data['solusi']); ?>" placeholder="Masukkan Solusi">
                    </div>
                    <div class="form-group">
