    ...
    <div class="card border-left-primary shadow h-100 py-2">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-uppercase mb-1" style="color: #2193b0">Data Pasien</div>
...
<div class="col-xl-3 col-md-6 mb-4">
    <div class="card border-left-warning shadow h-100 py-2">
        <div class="card-body">
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Data Solusi</div>
...
<!-- DataTales Example -->
    <div class="data-table shadow ml-3 mb-4">
    <div class="card-header py-3" style="background: linear-gradient(to right, #2193b0, #6dd5ed);">
        <h6 class="m-0 font-weight-bold" style="color: #fff">Tabel Data Pasien</h6>
    </div>
    <div class="card-body">
        <form method="post" encytpe="multipart/form-data">
            <table class="data-tablee" id="dataTable" cellspacing="0">
                <thead>
                    <tr>
